...
main(int argc, char *argv[])
{
   ...
   7:	83 ec 10             	sub    $0x10,%esp
	int pid=fork();
   a:	e8 20 02 00 00       	call   22f <fork>
   f:	89 c3                	mov    %eax,%ebx
  11:	8d 76 00             	lea    0x0(%esi),%esi
	while(1){
	if(pid < 0) {
  14:	83 fb 00             	cmp    $0x0,%ebx
  17:	7c 20                	jl     39 <main+0x39>
		printf(1,"ERROR\n");
	} else if( pid == 0 ) {
  19:	74 35                	je     50 <main+0x50>
			printf(1,"Child\n");
			yield();
	} else {
			printf(1,"Paren\n");
  1b:	c7 44 24 04 b0 06 00 	movl   $0x6b0,0x4(%esp)
  22:	00 
  23:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  2a:	e8 51 03 00 00       	call   380 <printf>
			yield();
  2f:	e8 b3 02 00 00       	call   2e7 <yield>
	if(pid < 0) {
  34:	83 fb 00             	cmp    $0x0,%ebx
  37:	7d e0                	jge    19 <main+0x19>
		printf(1,"ERROR\n");
  39:	c7 44 24 04 a2 06 00 	movl   $0x6a2,0x4(%esp)
  40:	00 
  41:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  48:	e8 33 03 00 00       	call   380 <printf>
  4d:	eb c5                	jmp    14 <main+0x14>
  4f:	90                   	nop
			printf(1,"Child\n");
  50:	c7 44 24 04 a9 06 00 	movl   $0x6a9,0x4(%esp)
  57:	00 
  58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5f:	e8 1c 03 00 00       	call   380 <printf>
			yield();
  64:	e8 7e 02 00 00       	call   2e7 <yield>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 324:	f7 f1                	div    %ecx
 326:	8a 92 be 06 00 00    	mov    0x6be(%edx),%dl
...
printf(int fd, char *fmt, ...)
 ...
 53d:	e9 85 fe ff ff       	jmp    3c7 <printf+0x47>
          s = "(null)";
 542:	bf b7 06 00 00       	mov    $0x6b7,%edi
...
free(void *ap)
{
 ...
 558:	a1 50 09 00 00       	mov    0x950,%eax
 ...
 5c0:	89 10                	mov    %edx,(%eax)
  freep = p;
 5c2:	a3 50 09 00 00       	mov    %eax,0x950
}
 5c7:	5b                   	pop    %ebx
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5de:	46                   	inc    %esi
  if((prevp = freep) == 0){
 5df:	8b 15 50 09 00 00    	mov    0x950,%edx
 ...
 60b:	3b 05 50 09 00 00    	cmp    0x950,%eax
 ...
 635:	e8 12 ff ff ff       	call   54c <free>
  return freep;
 63a:	8b 15 50 09 00 00    	mov    0x950,%edx
 ...
 654:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 657:	89 15 50 09 00 00    	mov    %edx,0x950
      return (void*)(p + 1);
 ...
 678:	eb dd                	jmp    657 <malloc+0x8b>
    base.s.ptr = freep = prevp = &base;
 67a:	c7 05 50 09 00 00 54 	movl   $0x954,0x950
 681:	09 00 00 
 684:	c7 05 54 09 00 00 54 	movl   $0x954,0x954
 68b:	09 00 00 
    base.s.size = 0;
 68e:	c7 05 58 09 00 00 00 	movl   $0x0,0x958
 695:	00 00 00 
 698:	b8 54 09 00 00       	mov    $0x954,%eax
