...
main(int argc, char *argv[])
  ...
  41:	c7 44 24 04 ba 06 00 	movl   $0x6ba,0x4(%esp)
  48:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 328:	f7 f1                	div    %ecx
 32a:	8a 92 da 06 00 00    	mov    0x6da(%edx),%dl
...
printf(int fd, char *fmt, ...)
 ...
 541:	e9 85 fe ff ff       	jmp    3cb <printf+0x47>
          s = "(null)";
 546:	bf d3 06 00 00       	mov    $0x6d3,%edi
...
free(void *ap)
{
 ...
 55c:	a1 70 09 00 00       	mov    0x970,%eax
 ...
 597:	89 10                	mov    %edx,(%eax)
  freep = p;
 599:	a3 70 09 00 00       	mov    %eax,0x970
}
 59e:	5b                   	pop    %ebx
 59f:	5e                   	pop    %esi
 5a0:	5f                   	pop    %edi
 ...
 5c4:	89 10                	mov    %edx,(%eax)
  freep = p;
 5c6:	a3 70 09 00 00       	mov    %eax,0x970
}
 5cb:	5b                   	pop    %ebx
 5cc:	5e                   	pop    %esi
 5cd:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 5e2:	46                   	inc    %esi
  if((prevp = freep) == 0){
 5e3:	8b 15 70 09 00 00    	mov    0x970,%edx
 ...
 60f:	3b 05 70 09 00 00    	cmp    0x970,%eax
 ...
 639:	e8 12 ff ff ff       	call   550 <free>
  return freep;
 63e:	8b 15 70 09 00 00    	mov    0x970,%edx
 ...
 658:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 65b:	89 15 70 09 00 00    	mov    %edx,0x970
      return (void*)(p + 1);
 ...
 67c:	eb dd                	jmp    65b <malloc+0x8b>
    base.s.ptr = freep = prevp = &base;
 67e:	c7 05 70 09 00 00 74 	movl   $0x974,0x970
 685:	09 00 00 
 688:	c7 05 74 09 00 00 74 	movl   $0x974,0x974
 68f:	09 00 00 
    base.s.size = 0;
 692:	c7 05 78 09 00 00 00 	movl   $0x0,0x978
 699:	00 00 00 
 69c:	b8 74 09 00 00       	mov    $0x974,%eax
